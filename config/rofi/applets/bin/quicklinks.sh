...
if [[ ("$theme" == *'type-1'*) || ("$theme" == *'type-5'*) ]]; then
    efonts="DankMono Nerd Font 10"
else
    efonts="Symbols Nerd Font 28"
fi
...
run_cmd() {
    if [[ "$1" == '--opt1' ]]; then
        ...
        zen-browser -P Inaoe 'https://core.ac.uk'
        zen-browser -P Inaoe 'https://openalex.org'
        zen-browser -P Inaoe 'https://incitefulmed.com/academic/'
        ...
        zen-browser -P Inaoe 'https://jcr.clarivate.com/jcr/home'
