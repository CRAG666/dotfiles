...
key.map_lazy('neotest', setup_neotest, 'n', ';t', '', { desc = '+Neotest' })
key.map_lazy('neotest', setup_neotest, 'n', ';tt', function()
  require('neotest').run.run(vim.fn.expand('%'))
end, { desc = 'Run File (Neotest)' })
key.map_lazy('neotest', setup_neotest, 'n', ';tT', function()
  require('neotest').run.run(vim.uv.cwd())
end, { desc = 'Run All Test Files (Neotest)' })
key.map_lazy('neotest', setup_neotest, 'n', ';tr', function()
  require('neotest').run.run()
end, { desc = 'Run Nearest (Neotest)' })
key.map_lazy('neotest', setup_neotest, 'n', ';tl', function()
  require('neotest').run.run_last()
end, { desc = 'Run Last (Neotest)' })
key.map_lazy('neotest', setup_neotest, 'n', ';ts', function()
  require('neotest').summary.toggle()
end, { desc = 'Toggle Summary (Neotest)' })
key.map_lazy('neotest', setup_neotest, 'n', ';to', function()
...
key.map_lazy('neotest', setup_neotest, 'n', ';tw', function()
  require('neotest').watch.toggle(vim.fn.expand('%'))
end, { desc = 'Toggle Watch (Neotest)' })
key.map_lazy('neotest', setup_neotest, 'n', ';td', function()
